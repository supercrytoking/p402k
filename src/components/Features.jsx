export default function Features() {
    return (
        <>
            <div
                id='features'
                className='bg-gradient-to-t from-gray-800 to-gray-900 text-gray-400 relative border-b border-gray-700 shadow-xl'>
                <div className='container relative z-10 mx-auto py-24 px-6'>
                    <div className='grid grid-cols-1 gap-16 md:grid-cols-3 text-center'>
                        <div className='space-y-4'>
                            ...
                            <p className=' text-white text-2xl font-extrabold'>Always Undetected</p>
                        ...
                        <div className='space-y-4 hidden md:block'>
                            ...
                            <p className='text-white text-2xl font-extrabold'>Affordable and Transparent</p>
                            <p className='max-w-sm  mx-auto'>
